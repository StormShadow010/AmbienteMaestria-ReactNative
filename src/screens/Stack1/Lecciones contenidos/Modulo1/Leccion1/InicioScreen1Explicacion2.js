...
const InicioScreen1Explicacion2 = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      1. La función print() admite varios argumentos seguidos. En el programa, los argumentos deben separarse por comas. Así estos se muestran en el mismo orden y en la misma línea, separados por espacios
      </Text>
...
export default InicioScreen1Explicacion2